            ...
            <div class="container-fluid">
                <div class="col-md-8 offset-2">
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('companyJobs.store') }}" method="post" role="form">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="deadline" value="{{ old('deadline') }}" class="form-control"
                                        placeholder="Enter Job deadline Name">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name"
                                        value="{{ auth()->user()->company_name ?? old('company_name') }}"
                                        class="form-control" placeholder="Enter Job Company Name">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="job_description" value="{{ old('job_description') }}"
                                        class="form-control" placeholder="Enter Job description Name">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="qualification" value="{{ old('qualification') }}"
                                        class="form-control" placeholder="Enter Job qualification Name">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="vacancy" value="{{ old('vacancy') }}"
