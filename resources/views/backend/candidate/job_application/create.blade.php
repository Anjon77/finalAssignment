                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header mb-3">
                            <h3 class="card-title">Submit Your Job Application Form</h3>
                        </div>
                        ...
                        <form action="{{ url('candidate/job-application/store') }}" method="post" role="form"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="cover_letter" name="cover_letter" rows="4"
                                        placeholder="Enter your cover letter here">{{ old('cover_letter') }}</textarea>
