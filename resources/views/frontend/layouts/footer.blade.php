<div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
            <a href="{{ url('/') }}" class="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0"
                ...
                <span class="text-white">Job Pulse</span>
            </a>
            <p>
            ...
            <div class="d-flex justify-content-start mt-4">
                ...
                <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px"
                    href="{{ url('https://www.facebook.com/') }}"><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                    style="width: 38px; height: 38px" href="{{ url('https://www.linkedin.com/') }}"><i
        ...
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="{{ url('jobs') }}"><i class="fa fa-angle-right mr-2"></i>Jobs</a>
                <a class="text-white mb-2" href="{{ url('blogs') }}"><i class="fa fa-angle-right mr-2"></i>Our
                    Blogs</a>
    ...
    <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, 0.2) ;">
        <p class="m-0 text-center text-white">
            &copy;
            <a class="text-primary font-weight-bold" href="#">Job Pulse</a>.
            All Rights Reserved.

            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
            Developed by
            <a class="text-primary font-weight-bold" href="#">Anjon Kumar Deb</a>
